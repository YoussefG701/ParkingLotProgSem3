...
public class log_in {
    ...
    public static void load_user_From_File() {
        try (BufferedReader reader = new BufferedReader(new FileReader("E:/Uni/Java/OOP Project Sem 3/users/users.txt"))) {
            String line;
    ...
    public static void load_bikeSlots_From_File() {
        try (BufferedReader reader = new BufferedReader(new FileReader("E:/Uni/Java/OOP Project Sem 3/users/bike.txt"))) {
            String line;
            while ((line = reader.readLine()) != null) {
                String[] userInfo = line.split(" ");
    ...
    public static void load_NormalSlots_From_File() {
        try (BufferedReader reader = new BufferedReader(new FileReader("E:/Uni/Java/OOP Project Sem 3/users/normal.txt"))) {
            String line;
            while ((line = reader.readLine()) != null) {
                String[] userInfo = line.split(" ");
    ...
    public static void load_LargeSlots_From_File() {
        try (BufferedReader reader = new BufferedReader(new FileReader("E:/Uni/Java/OOP Project Sem 3/users/large.txt"))) {
            String line;
            while ((line = reader.readLine()) != null) {
                String[] userInfo = line.split(" ");
